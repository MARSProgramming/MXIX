...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
     ...
     */
    private Notifier telemetryNotifier;
    ...
    public Swerve() {
      ...
      telemetryNotifier = new Notifier(this::updateTelemetry);
      telemetryNotifier.setName("Swerve Telemetry");
      telemetryNotifier.startPeriodic(0.05); // 20 Hz telemetry
