...
public class AimAndShootOnTheMove extends Command {
    ...
    public void execute() {
        ...
        DogLog.log("AimAndShootOnTheMove/CowlTarget",   cowlAngle);
        DogLog.log("AimAndShootOnTheMove/RPMTarget",     rpm);
        DogLog.log("AimAndShootOnTheMove/VirtualAngle",  sotm.virtualTargetAngle.getDegrees());
        DogLog.log("AimAndShootOnTheMove/AngularVelFF",  sotm.angularVelocityRadPerSec);
